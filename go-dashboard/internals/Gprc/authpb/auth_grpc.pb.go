...
func (c *authServiceClient) IsAuth(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_IsAuth_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) IsAuth(context.Context, *AuthRequest) (*AuthResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IsAuth not implemented")
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internals/Gprc/authpb/auth.proto",
}
